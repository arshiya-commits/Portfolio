...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    const form = new FormData();
    form.append("access_key", "4ad30097-04dc-4baa-942a-ecc38259b290"); // ✅ Your Web3Forms access key
    form.append("name", formData.name);
    form.append("email", formData.email);
    form.append("subject", formData.subject || "New Contact Form Submission");
    form.append("message", formData.message);
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold">Email</h3>
                    <p className="text-gray-400">arshiyashaiik@gmail.com</p>
                  </div>
                </div>

                <div className="flex items-center space-x-4">
                  <a
                    href="https://github.com/arshiya-commits"
                    target="_blank"
                ...
                <div className="flex items-center space-x-4">
                  <a
                    href="https://www.linkedin.com/in/arshiya-shaik-9a2748280"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center space-x-3 text-gray-400 hover:text-white transition"
                  >
